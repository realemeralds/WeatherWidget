      ...
      >
        ...
        <div class="flex flex-col items-center justify-center text-white">
          <div class="relative z-10">
            <div
              class="absolute -inset-6 -top-3 -z-10 rounded-2xl border border-dashed border-white bg-slate-700"
            ></div>
            <div class="relative z-20">
              <p class="mr-1 text-center text-xl">now</p>
...
let qVariables: ref<RouteParams>;

qVariables = ref(route.query);
console.log(
  qVariables?.value && qVariables?.value.lat && qVariables?.value.lon
);
